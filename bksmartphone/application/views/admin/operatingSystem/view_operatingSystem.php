...
$(document).ready(function(){
    $("#add_screenlevel").click(function()
    {
        ...
        location.href = 'http://localhost/bksmartphone/index.php/admin/phone/operatingSystem/insert' ;
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-size: 1.2em;vertical-align:middle">
                                	<div class="row" style="padding-left: 15px">
                                	 	<a href="<?php echo site_url('admin/phone/operatingSystem/update/'.$row->id) ?>">
                                	 		<span class="glyphicon glyphicon-pencil fa-5x" aria-hidden="true"></span>
                                		</a> 
                                	 	<a href="<?php echo site_url('admin/phone/operatingSystem/delete/'.$row->id) ?>" onclick="return confirm('Are you sure you want to delete?')"> 
