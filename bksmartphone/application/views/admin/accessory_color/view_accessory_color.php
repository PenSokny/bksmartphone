...
$(document).ready(function(){
    $("#add_screenlevel").click(function()
    {
        ...
        location.href = 'http://localhost/bksmartphone/index.php/admin/accessory/accessory_color/insert' ;
		...
		<div class="panel-body">
                <table class="table table-bordered table-responsive table-striped" id="events_list">
                    ...
                    <tbody>
                    		 ...
                    		 <?php foreach ($accessory_color as $row) { ?>
                            
                            <tr>
                           
                           
                                <td class="col-sm-2 text-center"><?php echo $row->id ?> </td>
                                <td style="text-align: center; font-size: 1.2em;vertical-align:middle"> <?php echo $row->accessories_id ?></td>   
                                ...
                                <td style="text-align: center; font-size: 1.2em;vertical-align:middle">
                                	<div class="row" style="padding-left: 15px">
                                	 	<a href="<?php echo site_url('admin/accessory/accessory_color/update/'.$row->id) ?>">
                                	 		<span class="glyphicon glyphicon-pencil fa-5x" aria-hidden="true"></span>
                                		</a> 
                                	 	<a href="<?php echo site_url('admin/accessory/accessory_color/delete/'.$row->id) ?>" onclick="return confirm('Are you sure you want to delete?')"> 
